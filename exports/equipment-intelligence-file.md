# ARUS Equipment Intelligence — File for Claude Evaluation

Consolidated AI/ML/PdM view with fleet summary, risk-sorted equipment list, and detailed drawer. Hexagonal architecture. Coexists with standalone PdM Dashboard, PdM Pack, PdM Platform, and Digital Twin pages.

---

## File: `client/src/pages/equipment-intelligence.tsx`
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  <Link
                    href="/digital-twin"
                    className="px-3 py-2 rounded-lg bg-white/[0.015] border border-slate-700/10 text-xs text-slate-400 hover:bg-violet-400/5 hover:border-violet-400/12 hover:text-violet-300 transition-colors no-underline"
                  ...
                  <Link
                    href="/pdm-pack"
                    className="px-3 py-2 rounded-lg bg-white/[0.015] border border-slate-700/10 text-xs text-slate-400 hover:bg-orange-400/5 hover:border-orange-400/12 hover:text-orange-300 transition-colors no-underline"
                  ...
                  <Link
                    href="/pdm-dashboard"
                    className="px-3 py-2 rounded-lg bg-white/[0.015] border border-slate-700/10 text-xs text-slate-400 hover:bg-blue-400/5 hover:border-blue-400/12 hover:text-blue-300 transition-colors no-underline"
                  ...
                  <Link
                    href="/pdm-platform"
                    className="px-3 py-2 rounded-lg bg-white/[0.015] border border-slate-700/10 text-xs text-slate-400 hover:bg-emerald-400/5 hover:border-emerald-400/12 hover:text-emerald-300 transition-colors no-underline"
