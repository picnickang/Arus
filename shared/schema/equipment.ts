...
export const equipment = pgTable(
  "equipment",
  {
    ...
    emergencyLaborMultiplier: numeric("emergency_labor_multiplier", { precision: 6, scale: 3, mode: "number" }),
    emergencyPartsMultiplier: numeric("emergency_parts_multiplier", { precision: 6, scale: 3, mode: "number" }),
    emergencyDowntimeMultiplier: numeric("emergency_downtime_multiplier", { precision: 6, scale: 3, mode: "number" }),
...
export const equipmentDecommissionEvents = pgTable(
  "equipment_decommission_events",
  {
    ...
    bookValueAtRemoval: numeric("book_value_at_removal", { precision: 12, scale: 2, mode: "number" }),
