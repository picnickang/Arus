...
export const purchaseOrderItems = pgTable(
  "purchase_order_items",
  {
    ...
    receivedQuantity: numeric("received_quantity", { precision: 12, scale: 3, mode: "number" }).default(0),
...
export const purchaseRequestItems = pgTable(
  "purchase_request_items",
  {
    ...
    quantityFulfilled: numeric("quantity_fulfilled", { precision: 12, scale: 3, mode: "number" }).default(0),
