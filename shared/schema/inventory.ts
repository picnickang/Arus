...
export const stock = pgTable(
  "stock",
  {
    ...
    quantityOnHand: numeric("quantity_on_hand", { precision: 12, scale: 3, mode: "number" }).default(0),
    quantityReserved: numeric("quantity_reserved", { precision: 12, scale: 3, mode: "number" }).default(0),
    quantityOnOrder: numeric("quantity_on_order", { precision: 12, scale: 3, mode: "number" }).default(0),
