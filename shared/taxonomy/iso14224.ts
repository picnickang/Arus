...
export const ISO_14224_FAILURE_MODES = [
  // ── Mechanical
  {
    ...
    label: "Breakdown",
    category: "mechanical",
    description: "Loss of function caused by mechanical breakdown of equipment.",
  },
  {
    code: "LOO",
    label: "Loss of output",
    category: "mechanical",
    description: "Equipment does not deliver the specified output (flow, power, torque).",
  },
  {
    code: "VIB",
    label: "Vibration",
    category: "mechanical",
    description: "Excessive vibration above the alarm threshold for the equipment class.",
  },
  {
    code: "NOI",
    label: "Abnormal noise",
    category: "mechanical",
    description: "Abnormal acoustic signature outside the equipment's normal envelope.",
  },
  {
    code: "OVH",
    label: "Overheating",
    category: "mechanical",
    description: "Temperature exceeds the documented operating limit.",
  },
  {
    code: "ELP",
    label: "External leakage — process medium",
    category: "mechanical",
    description: "Process fluid leaks to the external environment.",
  },
  {
    code: "ELU",
    label: "External leakage — utility medium",
    category: "mechanical",
    description: "Utility fluid (lube oil, coolant, hydraulic) leaks to the external environment.",
  },
  {
    code: "INL",
    label: "Internal leakage",
    category: "mechanical",
    description: "Process fluid bypasses internal seals or barriers within the equipment.",
  },
  {
    code: "PDE",
    label: "Parameter deviation",
    category: "mechanical",
    description: "Operating parameter drifts outside the acceptable band.",
  },
  {
    code: "STD",
    label: "Structural deficiency",
    category: "mechanical",
    description: "Crack, deformation, or fatigue damage in load-bearing structure.",
  },

  // ── Electrical
  {
    code: "ERO",
    label: "Erratic output",
    category: "electrical",
    description: "Output signal or power fluctuates without commanded change.",
  },
  {
    code: "FTS",
    label: "Fail to start on demand",
    category: "electrical",
    description: "Equipment fails to start when commanded.",
  },
  {
    code: "FTO",
    label: "Fail to open",
    category: "electrical",
    description: "Breaker, contactor or valve fails to open on command.",
  },
  {
    code: "FTC",
    label: "Fail to close",
    category: "electrical",
    description: "Breaker, contactor or valve fails to close on command.",
  },
  {
    code: "STP",
    label: "Spurious stop",
    category: "electrical",
    description: "Equipment stops without commanded shutdown.",
  },
  {
    code: "FOF",
    label: "Fail to function on demand",
    category: "electrical",
    description: "Component does not perform its intended function when called.",
  },
  ...
  // ── Instrument
  {
    ...
    category: "instrument",
    description: "Sensor reading inconsistent with process state or peer sensors.",
  },
  {
    code: "NOO",
    label: "No signal / indication / alarm",
    category: "instrument",
    description: "Expected signal, indication or alarm is absent.",
  },
  {
    code: "FAI",
    label: "Faulty information",
    category: "instrument",
    description: "Information presented is incorrect (stale, frozen, miscalibrated).",
  },
  {
    code: "DOP",
    label: "Delayed operation",
    category: "instrument",
    description: "Function completes outside the specified response time.",
  },
  {
    code: "HIO",
    label: "High output / over-range",
    category: "instrument",
    description: "Reading pinned above the upper measurement range.",
  },
  {
    code: "LOO_I",
    label: "Low output / under-range",
    category: "instrument",
    description: "Reading pinned below the lower measurement range.",
  },

  // ── Process
  {
    code: "PLU",
    label: "Plugged / choked",
    category: "process",
    description: "Flow path is blocked by debris, scale, hydrate, ice or solidified fluid.",
  },
  {
    code: "CON",
    label: "Contamination",
    category: "process",
    description: "Process or utility fluid contaminated outside the acceptable spec.",
  },
  ...
  // ── Structural
  {
    ...
    label: "Corrosion",
    category: "structural",
    description: "Loss of material from corrosive attack on metal surfaces.",
  },
  {
    code: "ERO_S",
    label: "Erosion",
    category: "structural",
    description: "Loss of material from particle or cavitation impact.",
  },
  {
    code: "MOF",
    label: "Mechanical failure — general",
    category: "structural",
    description: "Mechanical loss of integrity not covered by a more specific code.",
  },

  // ── Operational / external
  {
    code: "OHE",
    label: "Overheating — external cause",
    category: "external",
    description: "Heat ingress from an external source drives the equipment above limits.",
  },
  {
    code: "INF",
    label: "Insufficient supply / starvation",
    category: "external",
    description: "Inadequate feed of fuel, air, coolant or driver power from upstream.",
  },
  {
    code: "OOP",
    label: "Out of adjustment",
    category: "operational",
    description: "Equipment is operating outside its commissioned set-points.",
  },
  ...
  // ── Unknown / not yet diagnosed
  {
    ...
    label: "Unknown",
    category: "unknown",
    description: "Failure mode not yet diagnosed; cause investigation pending.",
  },
  {
    code: "OTH",
    label: "Other",
    category: "unknown",
    description: "Failure mode does not match any other ISO 14224 code in this set.",
  },
