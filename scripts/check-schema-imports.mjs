...
const ALLOWED_FILES = new Set([
  ...
  "server/domains/equipment/infrastructure/lifecycle-repository-adapter.ts",
  "server/domains/equipment/domain/lifecycle-validation.ts",
  "server/domains/permissions/infrastructure/repository.ts",
  "server/domains/permissions/infrastructure/repository-access-queries.ts",
