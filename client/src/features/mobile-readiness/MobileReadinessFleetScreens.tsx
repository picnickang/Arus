...
function VesselActionTile({ tile }: { tile: SummaryMetric }) {
  ...
  const href = vesselActionHref(tile.id);
  return (
    <Link
      href={href}
...
function zoneActionIcon(action: string) {
  if (action === "Machinery") {
    return <Wrench className="h-3.5 w-3.5 text-primary" aria-hidden="true" />;
  }
  if (action === "Alarm") {
    return <AlertTriangle className="h-3.5 w-3.5 text-red-600" aria-hidden="true" />;
  }
  if (action === "Log") {
    return <FileText className="h-3.5 w-3.5 text-amber-600" aria-hidden="true" />;
  }
...
function VesselDiagramPanel({
  ...
  return (
    <SectionCard
      ...
      action={<button className="text-sm font-semibold text-primary">Legend</button>}
    >
      ...
      <div className="px-3 pb-3">
        ...
        <div className="mt-3 rounded-lg border border-slate-200 bg-white p-3">
          <div className="flex items-center justify-between">
            ...
            <button className="text-xs font-semibold text-primary">View section</button>
          </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? "border-primary bg-primary text-white" : "border-slate-200 bg-white text-slate-600"
      )}
    >
