        ...
        <Content className="space-y-2 pt-2">
          ...
          >
            ...
            <Link
              ...
              className="flex min-h-8 items-center justify-between px-3 text-xs font-semibold text-primary"
            >
          ...
          <SectionCard
            ...
            action={<button className="text-sm font-semibold text-primary">History</button>}
          >
      ...
      <div data-testid="mobile-readiness-screen-inventory">
        ...
        <Content className="space-y-1.5 pt-2">
          ...
          <div className="grid grid-cols-3 rounded-lg bg-slate-100 p-1 text-sm font-semibold">
            <button className="rounded-md bg-primary py-1.5 text-white">Inventory</button>
            ...
            action={
              <div className="flex items-center gap-2">
                <div className="grid grid-cols-2 rounded-md border border-slate-200 bg-white p-0.5">
                  ...
                  <button
                    className="grid h-7 w-7 place-items-center rounded bg-primary text-white"
...
function systemSettingsHref(label: string): string {
          ...
          <SectionCard>
            {settings.items.map((item) => {
              ...
              return (
                <Link
                  key={item.label}
                  href={systemSettingsHref(item.label)}
