        ...
        <Content className="space-y-2 pt-2">
          ...
          <div className="flex gap-4 overflow-x-auto border-b border-slate-200">
            {work.filters.map((filter) => (
              <button
                key={filter.id}
                className="shrink-0 border-b-2 border-transparent px-1 pb-1.5 text-sm font-semibold text-slate-600 first:border-brand first:text-brand"
              >
      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          <div className="mb-0.5 flex items-center gap-2 text-[11px] font-bold">
            ...
            <span className="text-brand">{orderCode}</span>
        ...
        <Content className="space-y-2 pb-28 pt-2">
            ...
            {["Work", "Details", "History", "Linked"].map((tab, index) => (
              <button
                ...
                className={cn(
                  ...
                  index === 0 && "border-brand text-brand"
                )}
              >
                {tab}
              </button>
          ...
          <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            <div className="grid grid-cols-4 gap-2 p-2">
              ...
              <button className="grid h-16 place-items-center rounded-lg border border-slate-200 text-brand">
          ...
          <div className="sticky bottom-16 z-20 grid grid-cols-[0.8fr_1fr_1.1fr] gap-2 bg-brand-mist/95 py-1.5">
            <button className="min-h-10 rounded-lg border border-slate-200 bg-white text-xs font-semibold text-slate-600">
              Actions
            </button>
            <button className="min-h-10 rounded-lg border border-slate-200 bg-white text-xs font-semibold text-brand">
              {execution.offlineDraftAction}
            </button>
            <button className="min-h-10 rounded-lg bg-brand-navy text-xs font-semibold text-white">
        ...
        <Content className="space-y-2 pb-20 pt-2">
          ...
          >
            <div className="space-y-2 p-3">
              ...
              <button className="text-xs font-semibold text-brand">View More History</button>
            </div>
          </SectionCard>
