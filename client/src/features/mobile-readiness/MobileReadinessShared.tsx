...
export function KpiStrip({ metrics, compact = false }: { metrics: SummaryMetric[]; compact?: boolean }) {
  return (
    <div
      className={cn(
...
}export function MiniState({ label, value, tone }: { label: string; value: string; tone: ReadinessTone }) {
  const toneClass = toneClasses(tone);
  return (
