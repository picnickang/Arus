      ...
      <div className="mx-auto flex min-h-[72px] w-full max-w-6xl items-center justify-between gap-3 px-4">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="truncate text-[26px] font-extrabold tracking-[0.08em] text-primary md:text-2xl">
              {title}
            </div>
        ...
        <div className="flex shrink-0 items-center gap-2">
          {vesselName || roleLabel ? (
            <div className="text-right">
              ...
              {roleLabel ? (
                <div className="text-xs font-semibold text-primary">{roleLabel}</div>
              ) : null}
            </div>
          ) : null}
          {right}
...
export function MobilePageShell({
  ...
  return (
    <div
      className={cn("min-h-screen bg-background text-slate-950", className)}
...
function bottomNavItemClass(usesReferenceTabBar: boolean, active: boolean): string {
  if (usesReferenceTabBar) {
    return active ? "text-primary" : "text-slate-500";
  }
  return active ? "bg-white/15 text-white shadow-inner" : "text-blue-100";
}
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                bottomNavItemClass(usesReferenceTabBar, active)
              )}
