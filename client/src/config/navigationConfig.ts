...
export { routeResourceMap } from "./navigationResources";
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: Ship,
        description: "Vessel records and fleet administration",
      },
      {
        name: "Equipment Registry",
        href: "/equipment",
        icon: Wrench,
        description: "Equipment records, lifecycle state, and vessel assignment",
      },
      {
        name: "Certificates",
        href: "/certificates",
