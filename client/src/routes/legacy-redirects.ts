...
const additionalRedirects: Array<{ from: string; to: string }> = [
  ...
  { from: "/pdm-pack", to: "/equipment-intelligence" },
  { from: "/pdm-dashboard", to: "/equipment-intelligence" },
  { from: "/pdm-platform", to: "/equipment-intelligence?system=true" },
  { from: "/digital-twin", to: "/equipment-intelligence" },
