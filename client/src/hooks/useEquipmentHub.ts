...
export interface WorkOrderSummary { id: string; title: string; status: string; createdAt: string; completedAt: string | null; }
export interface ServiceOrderSummary { id: string; title: string; status: string; vendorName: string | null; eta: string | null; createdAt: string; }
export interface DiagnosticRunSummary { id: string; analysisType: string; status: string; summary: string | null; createdAt: string; }
export interface ActivityTimelineEvent { id: string; type: string; title: string; description: string | null; timestamp: string; severity?: string; }
export interface NeedsActionItem { id: string; type: string; title: string; urgency: string; link: string; }
export interface OperationalContext { vesselStatus: string; nextPort: string | null; nextPortEta: string | null; partsAvailability: string; maintenanceWindow: string | null; }
