...
export default function PortalLoginPage() {
  ...
  if (view === "choose") {
    return (
      <div
        className="relative min-h-screen overflow-hidden bg-brand-ink-900"
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-b from-brand-ink-950 to-brand-ink-900"
      data-testid="page-portal-login"
    >
