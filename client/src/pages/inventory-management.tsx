      ...
      {activeTab === "purchasing" ? (
        ...
        <>
                ...
                <CardContent className="p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h3 className="text-xl md:text-2xl font-bold mt-1 text-destructive">
                        {stats.criticalCount}
                      </h3>
          ...
          <LowStockReplenishmentPanel
            ...
            onOpenChange={setReplenishmentOpen}
          />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Marine engine filter"
                            {...field}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              type="number"
                              min={name === "maxStockLevel" ? "1" : "0"}
                              placeholder="0"
                              value={field.value === 0 ? "0" : field.value || ""}
                              onChange={(e) => {
                                const val = e.target.value;
                                if (val === "") {
                                  field.onChange(name === "maxStockLevel" ? 1 : 0);
                                } else {
                                  const n = Number.parseInt(val, 10);
                                  field.onChange(
                                    Number.isNaN(n)
                                      ? 0
                                      : Math.max(name === "maxStockLevel" ? 1 : 0, n)
                                  );
                                }
                              }}
                              onBlur={field.onBlur}
