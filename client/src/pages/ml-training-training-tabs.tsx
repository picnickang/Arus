...
interface MLTrainingTabProps {
  training: MLTrainingData;
}

export function LstmTrainingTab({ training: t }: MLTrainingTabProps) {
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Teach the AI to recognize patterns in equipment data over time to predict failures before
          they happen
        </CardDescription>
      </CardHeader>
...
export function RandomForestTrainingTab({ training: t }: MLTrainingTabProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
      ...
      <CardContent className="space-y-4">
        ...
        >
          ...
          <AlertDescription className="text-blue-900 dark:text-blue-100">
            ...
            days based on availability). Data quality tier affects prediction confidence.
          </AlertDescription>
        </Alert>
        <Alert data-testid="alert-rf-info">
          ...
          <AlertDescription>
            ...
            statistics. Requires equipment with historical sensor data and maintenance records.
          </AlertDescription>
        </Alert>
...
export function AcousticAnalysisTab({ training: t }: MLTrainingTabProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
      ...
      <CardContent className="space-y-4">
        <Alert data-testid="alert-acoustic-info">
          ...
          <AlertDescription>
            ...
            patterns that may indicate bearing wear, cavitation, or mechanical issues.
          </AlertDescription>
        </Alert>
        <div className="space-y-2">
...
function AcousticResults({ training: t }: MLTrainingTabProps) {
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium" data-testid="text-health-score">
              {(result.healthScore ?? 0).toFixed(0)}%
            </span>
          </div>
        </div>
        {result.features && (
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 font-medium" data-testid="text-snr">
                {result.features.snr?.toFixed(1)} dB
              </span>
            </div>
          </div>
        )}
