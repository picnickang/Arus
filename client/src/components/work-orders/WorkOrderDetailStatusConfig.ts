/**
 * Status / priority badge configs for the work-order detail drawer. Extracted
 * from `WorkOrderDetailDrawerParts.tsx` to keep that file under the 500-line
 * hygiene ceiling once Prettier-formatted.
 */
