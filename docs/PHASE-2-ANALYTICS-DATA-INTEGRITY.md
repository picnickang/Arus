...
4. A.3: Org-Scoped Caching for Analytics
5. A.4: Analytics Route Contract Alignment
6. B.2: Data Reconciliation Jobs (depends on B.1)

**Week 5-6: Frontend & Dashboards**
7. C.1: TanStack Query Standardization
8. C.2: Data-TestID Coverage
9. B.3: Data Integrity Dashboards (depends on B.2)

**Week 7-8: Integration & Polish**
10. C.3: Wire New DTO Typings (depends on A.2)
11. End-to-end testing of all Phase 2 features
12. Documentation updates and architect review
