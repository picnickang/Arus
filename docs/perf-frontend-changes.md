...
- Dashboard: ___ renders
- Fleet Overview: ___ renders
- Work Orders: ___ renders
- Equipment: ___ renders
...
### Query Refetch Rates
- `/api/equipment/health`: ___ refetches/min
- `/api/dashboard`: ___ refetches/min
- `/api/work-orders`: ___ refetches/min
