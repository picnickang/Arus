...
// Inventory Stock
export const inventoryStockSqlite = sqliteTable(
  "inventory_stock",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id").notNull(),
...
export const crewRestSheetsSqlite = sqliteTable(
  "crew_rest_sheets",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id").notNull(),
...
```typescript
// ML Predictions
export const mlPredictionsSqlite = sqliteTable(
  "ml_predictions",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id").notNull(),
...
```typescript
// Insights Snapshots
export const insightsSnapshotsSqlite = sqliteTable(
  "insights_snapshots",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id").notNull(),
...
export const costSavingsRecordsSqlite = sqliteTable(
