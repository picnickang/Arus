 ...
 *
 * Hexagonal note: this service depends only on companion port declarations
...
import type { CrewServiceDependencies } from "./crew-service-ports.js";
export type {
  CrewExtensionsStoragePort,
  CrewNotificationSettingsLike,
  CrewServiceDependencies,
  CrewStoragePort,
  PermissionRolesPort,
} from "./crew-service-ports.js";
import type { SelectCrew, InsertCrew } from "../domain";
import { db } from "../../../db-config";
import { skills } from "@shared/schema-runtime";
import { eq, and } from "drizzle-orm";
import type { InsertCrewAlert, SelectCrewRole, InsertCrewRole } from "@shared/schema";
