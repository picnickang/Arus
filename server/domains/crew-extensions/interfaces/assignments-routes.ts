...
export function registerAssignmentsRoutes(app: Express, config: CrewExtensionsRoutesConfig) {
  ...
  app.get(
    ...
    withErrorHandling(
      ...
      async (req: AuthenticatedRequest, res: Response) => {
        ...
        const allAssignments = await dbCrewStorage.getCrewAssignments(orgId, {
  ...
  app.patch(
    "/api/crew-extensions/assignments/:id",
    withErrorHandling(
      ...
      async (req: AuthenticatedRequest, res: Response) => {
        ...
        res.json({
          ...
          vesselId: assignment.vesselId || "",
          startDate:
            assignment.start instanceof Date ? assignment.start.toISOString() : assignment.date,
  ...
  app.get(
    ...
    withErrorHandling("fetch crew assignments", async (req: Request, res: Response) => {
      ...
      const assignments = await dbCrewStorage.getCrewAssignments(undefined, {
        crewId: crew_id as string | undefined,
        vesselId: vessel_id as string | undefined,
      });
