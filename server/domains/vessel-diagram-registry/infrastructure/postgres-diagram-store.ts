...
export async function createPostgresDiagram(
  ctx: RegistryContext,
...
export async function getPostgresDiagram(
  ctx: RegistryContext,
  diagramId: string
...
export async function deletePostgresDiagram(
  ctx: RegistryContext,
  diagramId: string
): Promise<void> {
...
export async function listPostgresVersions(
  ctx: RegistryContext,
  diagramId: string
