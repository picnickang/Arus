...
export function getMaintenanceTablesSql(): SQL[] {
  return [
    ...
    sql`CREATE TABLE IF NOT EXISTS maintenance_costs (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, equipment_id TEXT NOT NULL, cost_type TEXT NOT NULL, amount REAL NOT NULL, currency TEXT DEFAULT 'SGD', description TEXT, work_order_id TEXT, created_at INTEGER)`,
    ...
    sql`CREATE TABLE IF NOT EXISTS port_call (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, vessel_id TEXT NOT NULL, port TEXT, start INTEGER, end INTEGER, arrival_time INTEGER, departure_time INTEGER, notes TEXT, created_at INTEGER)`,
    sql`CREATE TABLE IF NOT EXISTS drydock_window (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, vessel_id TEXT NOT NULL, yard TEXT, start INTEGER, end INTEGER, work_type TEXT, status TEXT DEFAULT 'planned', actual_cost REAL, notes TEXT, created_at INTEGER)`,
