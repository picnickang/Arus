...
export function getCrewTablesSql(): SQL[] {
  return [
    sql`CREATE TABLE IF NOT EXISTS crew (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, employee_id TEXT, first_name TEXT NOT NULL DEFAULT '', last_name TEXT NOT NULL DEFAULT '', name TEXT NOT NULL, rank TEXT, department TEXT, email TEXT, phone TEXT, watch_keeping TEXT, vessel_id TEXT, user_id TEXT, nationality TEXT, date_of_birth INTEGER, hire_date INTEGER, join_date INTEGER, contract_end_date INTEGER, is_active INTEGER DEFAULT 1, emergency_contact TEXT, notes TEXT, photo_path TEXT, crew_code TEXT, status TEXT DEFAULT 'active', employment_type TEXT, reports_to_id TEXT, rotation_on_days INTEGER, rotation_off_days INTEGER, created_at INTEGER, updated_at INTEGER)`,
