...
export function getInventoryTablesSql(): SQL[] {
  return [
    ...
    sql`CREATE TABLE IF NOT EXISTS purchase_order_items (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, po_id TEXT NOT NULL, part_id TEXT NOT NULL, quantity REAL NOT NULL, unit_price REAL NOT NULL, total_price REAL NOT NULL, received_quantity INTEGER DEFAULT 0, notes TEXT, created_at INTEGER)`,
    ...
    sql`CREATE TABLE IF NOT EXISTS part_failure_history (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, part_id TEXT NOT NULL, equipment_id TEXT, failure_date INTEGER NOT NULL, failure_mode TEXT, root_cause TEXT, mtbf_hours REAL, work_order_id TEXT, notes TEXT, created_at INTEGER)`,
...
export function getInventoryIndexesSql(): SQL[] {
  return [
    ...
    sql`CREATE INDEX IF NOT EXISTS idx_purchase_order_items_po ON purchase_order_items(po_id)`,
    sql`CREATE INDEX IF NOT EXISTS idx_purchase_order_items_org ON purchase_order_items(org_id)`,
