...
export function getMlTablesSql(): SQL[] {
  return [
    ...
    sql`CREATE TABLE IF NOT EXISTS failure_predictions (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, equipment_id TEXT NOT NULL, model_id TEXT, prediction_type TEXT NOT NULL, failure_probability REAL NOT NULL, estimated_days_to_failure REAL, confidence_interval_lower REAL, confidence_interval_upper REAL, contributing_factors TEXT, recommended_actions TEXT, prediction_date INTEGER NOT NULL, expires_at INTEGER, created_at INTEGER)`,
    ...
    sql`CREATE TABLE IF NOT EXISTS pdm_score_logs (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, equipment_id TEXT NOT NULL, score REAL NOT NULL, score_breakdown TEXT, confidence REAL, model_version TEXT, computed_at INTEGER NOT NULL, created_at INTEGER)`,
