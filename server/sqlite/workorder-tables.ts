...
export function getWorkOrderTablesSql(): SQL[] {
  return [
    sql`CREATE TABLE IF NOT EXISTS work_orders (id TEXT PRIMARY KEY, wo_number TEXT, org_id TEXT NOT NULL, equipment_id TEXT NOT NULL, vessel_id TEXT, status TEXT NOT NULL DEFAULT 'open', priority INTEGER NOT NULL DEFAULT 3, maintenance_type TEXT, work_order_type TEXT, reason TEXT, description TEXT, estimated_hours REAL, actual_hours REAL, estimated_cost_per_hour REAL, actual_cost_per_hour REAL, estimated_downtime_hours REAL, actual_downtime_hours REAL, total_parts_cost REAL DEFAULT 0, total_labor_cost REAL DEFAULT 0, total_cost REAL DEFAULT 0, roi REAL, downtime_cost_per_hour REAL, affects_vessel_downtime INTEGER DEFAULT 0, vessel_downtime_started_at INTEGER, assigned_crew_id TEXT, assignment_status TEXT, assignment_responded_at INTEGER, assignment_response_reason TEXT, required_skills TEXT, labor_hours REAL, labor_cost REAL, port_call_id TEXT, drydock_window_id TEXT, maintenance_window TEXT, maintenance_template_id TEXT, schedule_id TEXT, planned_start_date INTEGER, planned_end_date INTEGER, actual_start_date INTEGER, actual_end_date INTEGER, created_at INTEGER, updated_at INTEGER, version INTEGER DEFAULT 1, last_modified_by TEXT, last_modified_device TEXT)`,
