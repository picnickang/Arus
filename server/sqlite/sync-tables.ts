...
export function getSyncTablesSql(): SQL[] {
  return [
    ...
    sql`CREATE TABLE IF NOT EXISTS sheet_lock (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, sheet_type TEXT NOT NULL, sheet_id TEXT NOT NULL, locked_by TEXT NOT NULL, locked_at INTEGER NOT NULL, expires_at INTEGER NOT NULL, lock_reason TEXT)`,
    sql`CREATE TABLE IF NOT EXISTS sheet_version (id TEXT PRIMARY KEY, org_id TEXT NOT NULL, sheet_type TEXT NOT NULL, sheet_id TEXT NOT NULL, version INTEGER NOT NULL DEFAULT 1, last_modified_by TEXT, last_modified_at INTEGER, checksum TEXT)`,
...
export function getSyncIndexesSql(): SQL[] {
  return [
    ...
    sql`CREATE INDEX IF NOT EXISTS idx_sheet_lock_sheet ON sheet_lock(sheet_type, sheet_id)`,
    sql`CREATE INDEX IF NOT EXISTS idx_sheet_version_sheet ON sheet_version(sheet_type, sheet_id)`,
