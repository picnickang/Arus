...
import { dataPrivacyDsarStorage } from "../data-privacy-dsar-storage";
  ...
  router.get(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const requests = await dataPrivacyDsarStorage.getDataSubjectRequestsFiltered(orgId, {
  ...
  router.get(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const request = await dataPrivacyDsarStorage.getDataSubjectRequestWithOrg(id, orgId);
        if (!request) {
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const request = await dataPrivacyDsarStorage.createDataSubjectRequest({
          orgId,
          ...data,
          dueDate,
        });
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const existingRequest = await dataPrivacyDsarStorage.getDataSubjectRequestWithOrg(
          id,
          orgId
        );
        if (!existingRequest) {
        ...
        const request = await dataPrivacyDsarStorage.acknowledgeDataSubjectRequest(
          id,
          requestActorId(req),
          orgId
        );
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const collectedData = await dataPrivacyDsarStorage.collectUserDataForDsar(
          orgId,
          identifier,
          type
        );
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const result = await dataPrivacyDsarStorage.executeDataErasure(id, orgId, erasedBy, reason);
        await auditService.logEvent({
          orgId,
          eventCategory: "compliance_event",
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const request = await dataPrivacyDsarStorage.completeDataSubjectRequest(
          id,
          requestActorId(req),
          notes,
          orgId
  ...
  router.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const request = await dataPrivacyDsarStorage.rejectDataSubjectRequest(
          id,
          requestActorId(req),
  ...
  router.get(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const allRequests = await dataPrivacyDsarStorage.getDataSubjectRequestsFiltered(orgId, {});
