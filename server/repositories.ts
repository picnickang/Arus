...
const analyticsDeps: AnalyticsDependencies = {
  ...
  getLatestTelemetryReadings: async (vesselId, equipmentId, sensorType, limit, orgId) => dbTelemetryStorage.getLatestTelemetryReadings(vesselId, equipmentId, sensorType, limit || 500, orgId),
