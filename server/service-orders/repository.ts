...
// Runtime-only cycle: wo-so-bridge-operations imports generateSoNumber from
// here, but both sides use the other's export inside function bodies (never at
// module init), so the bindings are resolved by call time.
import {
