...
import type { AmosImportRow, AmosUpsertResult, ImportType } from "./types";
...
export async function upsertAmosRow(
    ...
    switch (type) {
      case "equipment":
        return upsertAmosEquipment(orgId, data, vesselId);
      case "work_orders":
        return upsertAmosWorkOrder(orgId, data, vesselId);
      case "parts":
        return upsertAmosPart(orgId, data);
