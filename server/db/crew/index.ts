...
export class DatabaseCrewStorage extends DbCrewMembers {
  ...
  async getCrewAssignments(orgId?: string, filters?: any) { return this.extended.getCrewAssignments(orgId, filters); }
  async getCrewAssignment(id: string, orgId?: string) { return this.extended.getCrewAssignment(id, orgId); }
  ...
  async createCrewCertification(cert: any) { return this.extended.createCrewCertification(cert); }
  async updateCrewCertification(id: string, updates: any, orgId?: string) { return this.extended.updateCrewCertification(id, updates, orgId); }
  async deleteCrewCertification(id: string, orgId?: string) { return this.extended.deleteCrewCertification(id, orgId); }
  async getExpiringCertifications(days?: number, orgId?: string) { return this.extended.getExpiringCertifications(days, orgId); }
  async getCrewLeave(crewId?: string, orgId?: string) { return this.extended.getCrewLeave(crewId, orgId); }
  async createCrewLeave(leave: any) { return this.extended.createCrewLeave(leave); }
  async updateCrewLeave(id: string, updates: any, orgId?: string) { return this.extended.updateCrewLeave(id, updates, orgId); }
  async deleteCrewLeave(id: string, orgId?: string) { return this.extended.deleteCrewLeave(id, orgId); }
  async getActiveCrewOnVessel(vesselId: string, date: Date, orgId: string) { return this.extended.getActiveCrewOnVessel(vesselId, date, orgId); }
}
