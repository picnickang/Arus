...
import {
  ...
  rollbackMlModel,
  updateMlModel,
} from "./db-ml-analytics-models.js";
...
export class DatabaseMlAnalyticsStorage {
  ...
  async updateMlModel(
    ...
    return updateMlModel(id, updates, orgId);
  }
