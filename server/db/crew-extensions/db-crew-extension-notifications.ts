...
import { db } from "../../db";
import { crewAlerts, crewNotificationSettings } from "@shared/schema-runtime";
import type { CrewNotificationSettings, InsertCrewAlert, SelectCrewAlert } from "@shared/schema";
