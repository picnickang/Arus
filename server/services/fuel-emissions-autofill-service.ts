...
export type {
  FuelEmissionsResult,
  TelemetryPeriod,
  FuelEmissionsSummary,
} from "./fuel-emissions/types";
...
export {
  ...
  calculateEmissions,
  getCIIRating,
} from "./fuel-emissions/calculations";
export { aggregateTelemetryForPeriod } from "./fuel-emissions/telemetry-aggregation";
export {
  createFuelEmissionsEntry,
  createFuelEmissionsEntryFromFMCC,
} from "./fuel-emissions/entry-creators";
