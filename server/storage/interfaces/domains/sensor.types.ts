...
export interface ISensorStorage {
  ...
  bulkCreateSensorConfigurations(configs: InsertSensorConfiguration[], overwriteExisting?: boolean): Promise<SensorConfiguration[]>;
  ...
  updateSensorTemplate(id: string, orgId: string, data: Partial<InsertSensorTemplate>): Promise<SensorTemplate>;
