...
export interface ILogbookStorage {
  // Deck Log Daily
  getDeckLogDaily(orgId: string, filters?: { vesselId?: string; startDate?: string; endDate?: string; status?: string }): Promise<DeckLogDaily[]>;
  ...
  signDeckLogDaily(id: string, signData: { signedByCrewId: string; signedByName: string; signedByRank: string }, orgId: string): Promise<DeckLogDaily>;
  lockDeckLogDaily(id: string, lockData: { lockedByUserId: string; lockedByUserName: string }, orgId: string): Promise<DeckLogDaily>;
  unlockDeckLogDaily(id: string, orgId: string): Promise<DeckLogDaily>;
  getDeckLogComplete(dailyLogId: string, orgId: string): Promise<{ daily: DeckLogDaily; hourly: DeckLogHourly[]; watches: DeckLogWatch[] } | undefined>;
  ...
  // Deck Log Events
  getDeckLogEvents(dayId: string, orgId: string, filters?: { eventType?: string; source?: string; startTime?: Date; endTime?: Date }): Promise<DeckLogEvent[]>;
  ...
  createDeckLogHourlyAutoFill(autoFill: InsertDeckLogHourlyAutoFill): Promise<DeckLogHourlyAutoFill>;
  updateDeckLogHourlyAutoFill(id: string, autoFill: Partial<InsertDeckLogHourlyAutoFill>): Promise<DeckLogHourlyAutoFill>;
  markAutoFillOverridden(hourlyLogId: string, overriddenFields: string[], userId: string, userName: string): Promise<DeckLogHourlyAutoFill>;

  // Engine Log Daily
  getEngineLogDaily(orgId: string, filters?: { vesselId?: string; startDate?: string; endDate?: string; status?: string }): Promise<EngineLogDaily[]>;
  ...
  signEngineLogDaily(id: string, signData: { signedByCrewId: string; signedByName: string; signedByRank: string }, orgId: string): Promise<EngineLogDaily>;
  lockEngineLogDaily(id: string, lockData: { lockedByUserId: string; lockedByUserName: string }, orgId: string): Promise<EngineLogDaily>;
  unlockEngineLogDaily(id: string, orgId: string): Promise<EngineLogDaily>;
  getEngineLogComplete(dailyLogId: string, orgId: string): Promise<{ daily: EngineLogDaily; hourly: EngineLogHourly[]; generators: EngineLogGenerator[]; watches: EngineLogWatch[] } | undefined>;
  ...
  // Engine Log Events
  getEngineLogEvents(dayId: string, orgId: string, filters?: { eventType?: string; source?: string; startTime?: Date; endTime?: Date }): Promise<EngineLogEvent[]>;
