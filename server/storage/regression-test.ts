...
export async function runStorageRegressionTests(): Promise<{
  passed: number;
  failed: number;
  results: TestResult[];
}> {
  ...
  results.push(
    await runTest("Equipment: list", async () => {
  ...
  results.push(
    await runTest("Vessels: list", async () => {
  ...
  results.push(
    await runTest("Work Orders: list", async () => {
  ...
  results.push(
    await runTest("Parts: list", async () => {
  ...
  results.push(
    await runTest("Alert Configs: list", async () => {
  ...
  results.push(
    await runTest("Maintenance Schedules: list", async () => {
  ...
  results.push(
    await runTest("Deck Log Daily: list", async () => {
  ...
  results.push(
    await runTest("Engine Log Daily: list", async () => {
  ...
  results.push(
    await runTest("STCW Rest: list", async () => {
      const sheets = await (dbStcwStorage.getCrewRestRange as object as () => Promise<unknown[]>)();
  ...
  results.push(
    await runTest("Sensor Configs: list", async () => {
