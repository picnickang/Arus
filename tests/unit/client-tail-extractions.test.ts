...
describe("client tail component extractions", () => {
  ...
  it("keeps findings cards and tasks behind the public findings card barrel", () => {
    ...
    expect(barrel).toContain("export type { UnifiedFindingItem }");
    expect(barrel).toContain("export { FindingCard }");
    expect(barrel).toContain("export { TasksSection }");
